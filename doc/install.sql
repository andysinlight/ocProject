...
CREATE TABLE `t_share_record` (
  ...
  `title` varchar(20)   COMMENT '分享记录标题',
  `name` varchar(20)   COMMENT '分享记录名称',
  `share_channel_name` varchar(20)   COMMENT '分享的渠道',
  `share_channel` varchar(20) COMMENT '分享的渠道',

  `share_category_name` varchar(20) COMMENT '栏目',
  `share_category` varchar(20) COMMENT '栏目',
  `share_order` varchar(20)  COMMENT '位置',

  `share_order_strategy_name` varchar(20)  COMMENT '位置',
  `share_order_strategy` int(10)  COMMENT '生成位置策略',
